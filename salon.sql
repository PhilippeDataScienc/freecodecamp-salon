...
INSERT INTO public.appointments VALUES (1, 1, 1, '22:00');
...
INSERT INTO public.customers VALUES (1, '223-9', 'Philippe');
INSERT INTO public.customers VALUES (2, '548-9', 'luc');
INSERT INTO public.customers VALUES (11, '159-987', 'Hervé');
INSERT INTO public.customers VALUES (12, '2157-84', 'Bob');
INSERT INTO public.customers VALUES (13, '254-87', 'Rémi');
...
--
-- Name: appointments fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);
